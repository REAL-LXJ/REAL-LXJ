...
本科就读于大连交通大学机械工程学院机械工程+软件工程五年制双专业，**TOE创新实验室成员**，负责**能量机关的制作、视觉及步兵机器人的嵌入式控制**。
...
| :----------------------------------------------------------- |
| **RA-L**一作在投，一个新颖的紧耦合视觉-深度-惯性里程计方法, 充分利用结构环境中精心筛选过的准确稳定的多模态路标来提高地面自主移动机器人在室内复杂结构场景下位姿估计的精度和鲁棒性。 |

## **实习经历**

------

### **OPPO研究院光子Lab—室内结构场景视觉位姿估计** 
...
基于亚特兰大世界假设融合视觉、IMU和轮速计实现复杂城市场景下低漂移的车辆位姿估计，并利用GPS的定位信息松耦合VIWO消除长期累积漂移。
